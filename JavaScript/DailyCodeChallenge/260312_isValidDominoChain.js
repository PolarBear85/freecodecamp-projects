function isValidDominoChain(dominoes) {
  ...
  for (let x = 1; x<dominoes.length; x++) {
...
Tests:
Passed:1. isValidDominoChain([[1, 3], [3, 6], [6, 5]]) should return true.
Passed:2. isValidDominoChain([[6, 2], [3, 4], [4, 1]]) should return false.
Passed:3. isValidDominoChain([[2, 5], [5, 6], [5, 1]]) should return false.
Passed:4. isValidDominoChain([[4, 3], [3, 1], [1, 6], [6, 6], [6, 5], [5, 1], [1, 1], [1, 4], [4, 4], [4, 2]]) should return true.
Passed:5. isValidDominoChain([[2, 3], [3, 3], [3, 6], [6, 1], [1, 4], [3, 5], [5, 5], [5, 4], [4, 2], [2, 2]]) should return false.
