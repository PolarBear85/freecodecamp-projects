function getElementSize(windowSize, elementVw, elementVh) {
  ...
  const width = elementVw.slice(0,-2)
  const height = elementVh.slice(0,-2)
  const dimensions = windowSize.split(" ")
  

  return `${dimensions[0]*(width/100)} x ${dimensions[2]*(height/100)}`
...
Tests
    ...
    Passed: 1. getElementSize("1200 x 800", "50vw", "50vh") should return "600 x 400".
    Passed: 2. getElementSize("320 x 480", "25vw", "50vh") should return "80 x 240".
    Passed: 3. getElementSize("1000 x 500", "7vw", "3vh") should return "70 x 15".
    Passed: 4. getElementSize("1920 x 1080", "95vw", "100vh") should return "1824 x 1080".
    Passed: 5. getElementSize("1200 x 800", "0vw", "0vh") should return "0 x 0".
    Passed: 6. getElementSize("1440 x 900", "100vw", "114vh") should return "1440 x 1026".
    */