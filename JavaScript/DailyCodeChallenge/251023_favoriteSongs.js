function favoriteSongs(playlist) {
  ...
  playlist.sort((a,b) => a.plays-b.plays)
  console.log(playlist)

  const mostPlayedTitle = playlist[playlist.length-1].title
  const secondMostTitle = playlist[playlist.length-2].title

  const returnArr = [mostPlayedTitle,secondMostTitle]
