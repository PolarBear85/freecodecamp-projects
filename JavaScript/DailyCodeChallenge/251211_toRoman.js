function toRoman(num) {
  ...
  const arr = Object.entries(romArr)

  for (let x = 0; x<arr.length; x++) {

    while (reduceNum >= arr[x][1]) {

      reduceNum -= arr[x][1]
      answerArr.push(arr[x][0])
    }
...
Tests
Passed:1. toRoman(18) should return "XVIII".
Passed:2. toRoman(19) should return "XIX".
Passed:3. toRoman(1464) should return "MCDLXIV".
Passed:4. toRoman(2025) should return "MMXXV".
Passed:5. toRoman(3999) should return "MMMCMXCIX".
