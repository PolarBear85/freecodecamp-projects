function computeScore(judgeScores, ...penalties) {
  ...
  let totalPoints = judgeScores
    ...
    if (penalties.length >= 1) {
      for (let x = 0;x<penalties.length; x++) {
        totalPoints -= penalties[x]
      }
    }
...
Tests
Passed:1. computeScore([10, 8, 9, 6, 9, 8, 8, 9, 7, 7], 1) should return 64.
Passed:2. computeScore([10, 10, 10, 10, 10, 10, 10, 10, 10, 10]) should return 80.
Passed:3. computeScore([10, 8, 9, 10, 9, 8, 8, 9, 10, 7], 1, 2, 1) should return 67.
Passed:4. computeScore([8.0, 8.5, 9.0, 8.5, 9.0, 8.0, 9.0, 8.5, 9.0, 8.5], 0.5, 1.0) should return 67.5.
Passed:5. computeScore([6.0, 8.5, 7.0, 9.0, 7.5, 8.0, 6.5, 9.5, 7.0, 8.0], 1.5, 0.5, 0.5) should return 59.
*/