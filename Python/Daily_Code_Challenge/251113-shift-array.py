def shift_array(arr, n):
    ...
    shift_amount  = n % len(arr)
    print(shift_amount)

    new_list = arr[shift_amount:] + arr[:shift_amount]
    print(new_list)
...
Tests
Failed:1. shift_array([1, 2, 3], 1) should return [2, 3, 1].
Failed:2. shift_array([1, 2, 3], -1) should return [3, 1, 2].
Failed:3. shift_array(["alpha", "bravo", "charlie"], 5) should return ["charlie", "alpha", "bravo"].
Failed:4. shift_array(["alpha", "bravo", "charlie"], -11) should return ["bravo", "charlie", "alpha"].
