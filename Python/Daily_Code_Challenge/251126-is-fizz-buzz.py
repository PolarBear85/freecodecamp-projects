def is_fizz_buzz(sequence):
    ...
    for index,number in enumerate(sequence):
        ...
        print(index,this_index,number)

        if this_index % 15 == 0:
            if number != "FizzBuzz": return False

        elif this_index % 5 ==0:
            if number != "Buzz": return False

        elif this_index % 3 ==0:
            if number != "Fizz": return False

        elif not isinstance(number,int): return False

        elif this_index != number: return False
