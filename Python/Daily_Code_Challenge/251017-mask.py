def mask(card):
    ...
    star_card = ["*" if char.isdigit() else char for char in card[:-4]]
        
    print("".join(star_card)+card[-4:])
    return "".join(star_card)+card[-4:]
...
Tests
Waiting:1. mask("4012-8888-8888-1881") should return "****-****-****-1881".
