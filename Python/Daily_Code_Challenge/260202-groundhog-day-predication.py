...
Tests
Passed:1. groundhog_day_prediction(True) should return "Looks like we'll have six more weeks of winter.".
Passed:2. groundhog_day_prediction(False) should return "It's going to be an early spring.".
Passed:3. groundhog_day_prediction(None) should return "No prediction this year.".
Passed:4. groundhog_day_prediction(" ") should return "No prediction this year.".
Passed:5. groundhog_day_prediction("True") should return "No prediction this year.".
'''