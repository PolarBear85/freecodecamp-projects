def adjust_thermostat(current_f, target_c):
    ...
    diff = round(target_f - current_f,1)
...
Tests
Passed:1. adjust_thermostat(32, 0) should return "Hold".
Passed:2. adjust_thermostat(70, 25) should return "Heat: 7.0 degrees Fahrenheit".
Passed:3. adjust_thermostat(72, 18) should return "Cool: 7.6 degrees Fahrenheit".
Passed:4. adjust_thermostat(212, 100) should return "Hold".
Passed:5. adjust_thermostat(59, 22) should return "Heat: 12.6 degrees Fahrenheit".
'''