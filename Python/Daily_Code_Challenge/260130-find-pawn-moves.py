...
Tests
Passed:1. find_pawn_moves("D4") should return ["D5"].
Passed:2. find_pawn_moves("B2") should return ["B3", "B4"].
Passed:3. find_pawn_moves("A7") should return ["A8"].
Passed:4. find_pawn_moves("G2") should return ["G3", "G4"].
Passed:5. find_pawn_moves("E3") should return ["E4"].
'''