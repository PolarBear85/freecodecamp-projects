...
def calculate_start_delays(jump_scores):
    ...
    answer = [math.ceil(abs(score - max_score)*1.5) for score in jump_scores]
...
Tests
Passed:1. calculate_start_delays([120, 110, 125]) should return [8, 23, 0].
Passed:2. calculate_start_delays([118, 125, 122, 120]) should return [11, 0, 5, 8].
Passed:3. calculate_start_delays([100, 105, 95, 110, 120, 115, 108]) should return [30, 23, 38, 15, 0, 8, 18].
Passed:4. calculate_start_delays([130, 125, 128, 120, 118, 122, 127, 115, 132, 124]) should return [3, 11, 6, 18, 21, 15, 8, 26, 0, 12].
'''